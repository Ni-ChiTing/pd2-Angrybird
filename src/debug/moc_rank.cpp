...
QT_MOC_LITERAL(1, 5, 12), // "onRankClosed"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 21) // "on_pushButton_clicked"

    },
    "rank\0onRankClosed\0\0on_pushButton_clicked"
};
...
void rank::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        rank *_t = static_cast<rank *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onRankClosed(); break;
        ...
        {
            typedef void (rank::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&rank::onRankClosed)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject rank::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_rank.data,
