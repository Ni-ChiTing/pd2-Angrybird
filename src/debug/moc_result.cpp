...
QT_MOC_LITERAL(3, 13, 7), // "restart"
QT_MOC_LITERAL(4, 21, 2), // "ok"
QT_MOC_LITERAL(5, 24, 8), // "setscore"
QT_MOC_LITERAL(6, 33, 1), // "a"
QT_MOC_LITERAL(7, 35, 23), // "on_pushButton_2_clicked"
QT_MOC_LITERAL(8, 59, 21), // "on_pushButton_clicked"
QT_MOC_LITERAL(9, 81, 23), // "on_pushButton_3_clicked"
QT_MOC_LITERAL(10, 105, 23) // "on_pushButton_4_clicked"

    },
    "result\0exit\0\0restart\0ok\0setscore\0a\0"
...
void result::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&result::exit)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (result::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&result::restart)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (result::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&result::ok)) {
                *result = 2;
                return;
            }
        }
